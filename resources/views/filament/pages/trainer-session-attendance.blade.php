<x-filament::page>
    <div class="attendance">
        <x-filament::section :heading="$record->activity->name ?? 'Schedule #' . $record->id">
            ...
            <div class="attendance-info-grid">
                <div class="attendance-info-card">
                    <div class="attendance-info-label">Time</div>
                ...
                <div class="attendance-info-card">
                    <div class="attendance-info-label">Trainer</div>
                    <div class="attendance-info-value">{{ $record->staff->full_name ?? '-' }}</div>
                </div>
                <div class="attendance-info-card">
                    <div class="attendance-info-label">Hall</div>
                    <div class="attendance-info-value">{{ $record->hall->name ?? '-' }}</div>
                </div>
            </div>

            <div class="attendance-kpi-grid">
                <div class="attendance-kpi-card">
                    <div class="attendance-kpi-label">Attendance rate</div>
                    <div class="attendance-kpi-value">{{ $this->kpi['attendance_rate'] }}%</div>
                </div>
                <div class="attendance-kpi-card">
                    <div class="attendance-kpi-label">Booked / Capacity</div>
                    <div class="attendance-kpi-value">{{ $this->kpi['booked_capacity'] }}</div>
                </div>
                <div class="attendance-kpi-card">
                    <div class="attendance-kpi-label">Free places</div>
                    <div class="attendance-kpi-value">{{ $this->kpi['free_places'] }}</div>
                </div>
                <div class="attendance-kpi-card">
                    <div class="attendance-kpi-label">No-show rate</div>
                    <div class="attendance-kpi-value">{{ $this->kpi['no_show_rate'] }}%</div>
                </div>
            </div>
